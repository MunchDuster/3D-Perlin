...
public class DriveCar : MonoBehaviour
{
    ...
    float xIn = 0;
    float yIn = 0;
    Vector3 GravDir = -Vector3.up;
    Vector3 Up;
    Vector3[] lastWheelPoss;
    //Functions
    void Start()
    {
    ...
    void LateUpdate()
    {
        ...
        Vector3 gravForce = GravDir * gravity * Time.deltaTime * rigidbody.mass;
        rigidbody.AddForce(gravForce, ForceMode.Impulse);
